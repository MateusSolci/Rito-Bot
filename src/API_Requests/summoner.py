...
# retorna informações do invocador, a partir do nickname
    ...
    def summoner_info(self, origin, nick):
        IDs = Summoner().summoner_ids(origin, nick)
        elo = Summoner().get_elo(origin, IDs['id'])
